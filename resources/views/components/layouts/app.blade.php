...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a target="_blank"
                href="https://api.whatsapp.com/send?phone=5516981294778&text=Gostaria%20de%20uma%20ajuda%20no%20sistema%20"
                class="flex items-center text-white py-4 pl-6 nav-item">
                {{-- <i class="fas fa-whatsapp h-5 w-5 mr-2"></i> --}}
                <svg class="h-5 w-5 mr-2 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                    <path
            ...
            <div x-data="{ isOpen: false }" class="relative w-1/2 flex justify-end">
                ...
                <div x-show="isOpen" class="absolute w-32 bg-white rounded-lg shadow-lg py-2 mt-16">
                    <a wire:navigate href="{{ route('profile') }}"
                        class="block px-4 py-2 account-link hover:text-white">Minha
                        Conta</a>
                    <a href="https://api.whatsapp.com/send?phone=5516981294778&text=Gostaria%20de%20uma%20ajuda%20no%20sistema%20"
                        target="_blank" class="block px-4 py-2 account-link hover:text-white">Suporte</a>
                    <a wire:navigate href="{{ route('logout') }}"
                        class="block px-4 py-2 account-link hover:text-white">Sair</a>
                </div>
            </div>
        </header>
