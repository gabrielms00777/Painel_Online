<x-site-layout>
  ...
  <div class="header_section ">
    ...
    <div class="banner_main">
       ...
       <p class="banner_text">Somos especialistas em criar software sob medida para atender às suas necessidades. De sites a sistemas complexos, nossa equipe está pronta para trazer suas ideias à vida.</p>
       <div class="btn_main">
    ...
    <div class="container">
       <div class="row">
          <div class="col-md-6">
             ...
             <p class="about_text">Somos uma empresa de desenvolvimento de software dedicada a criar soluções inovadoras e personalizadas para nossos clientes. Com anos de experiência no mercado, nossa equipe é composta por profissionais qualificados que trabalham juntos para atender às necessidades exclusivas de cada projeto. Desde sites até sistemas completos, entregamos qualidade e excelência em tudo o que fazemos.</p>
