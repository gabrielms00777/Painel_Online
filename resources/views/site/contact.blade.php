<x-site-layout>
    ...
    <div id="contact" class="contact_section layout_padding">
        <div class="container">
            ...
            <p style="text-align: center;">Entre em contato conosco para discutir seu projeto, solicitar um orçamento ou
                esclarecer dúvidas. Estamos aqui para ajudar.</p>
        </div>
    </div>
                        ...
                        <form action="{{ route('site.contact-post') }}" method="post">
                            ...
                            <div class="form-group">
                                <input type="text" class="email-bt" placeholder="Seu Nome"
                                    value="{{ old('name') ?? 'Teste' }}" name="name" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <textarea required class="massage-bt" placeholder="Sua Mensagem (Detalhe seu projeto, orçamento, etc.)" rows="5"
                                    id="comment" name="message">{{ old('message') ?? 'testeeeeee' }}</textarea>
                            </div>
