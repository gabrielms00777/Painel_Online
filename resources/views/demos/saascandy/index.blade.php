...
<head>
    ...
    <link rel="stylesheet" href="demos/saascandy/assets/libs/OwlCarousel-2/dist/assets/owl.carousel.min.css">
    <link rel="stylesheet" href="demos/saascandy/dist/css/iconfont/tabler-icons.css">
    <link rel="stylesheet" href="demos/saascandy/dist/css/style.css">
</head>
<body>
    <!------------------------------>
    <!-- Header Start -->
    ...
    <header class="main-header position-fixed w-100">
            <div class="container">
                <nav class="navbar navbar-expand-xl py-0">
                    <div class="logo">
                        <a class="navbar-brand py-0 me-0" href="#"><img src="demos/saascandy/assets/images/sasscandy-logo.svg" alt=""></a>
                    </div>
            ...
            <div class="offcanvas offcanvas-start"  tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                <div class="offcanvas-header">
                    <div class="logo">
                        <a class="navbar-brand py-0 me-0" href="#"><img src="demos/saascandy/assets/images/Creato-logo.svg" alt=""></a>
                    </div> 
            ...
            <div class="row d-flex flex-wrap align-items-center">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="position-relative right-hero-color">
                        <img src="demos/saascandy/assets/images/hero/right-image.svg" class="img-fluid"> 
                    </div>          
                </div>
            </div>
        </div>
    ...
    <section class="service position-relative overflow-hidden">
        <div class="container position-relative">
            <img src="demos/saascandy/assets/images/service/dot-shape.png" class="shape position-absolute">
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xxl-8 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <img src="demos/saascandy/assets/images/our-service/our-service.svg" class="img-fluid"> 
                </div>
        ...
        <div class="container position-relative" >
            <div class="portfolio-wrap">
                <div class="owl-carousel owl-theme portfolio-slider">
                        <div class="item"><a href="#"><img src="demos/saascandy/assets/images/portfolio/Portfolio.jpg" class="w-100"></a></div>
                        <div class="item"><a href="#"><img src="demos/saascandy/assets/images/portfolio/Portfolio.jpg" class="w-100"></a></div>
                        <div class="item"><a href="#"><img src="demos/saascandy/assets/images/portfolio/Portfolio.jpg" class="w-100"></a></div>
                        <div class="item"><a href="#"><img src="demos/saascandy/assets/images/portfolio/Portfolio.jpg" class="w-100"></a></div>
                        <div class="item"><a href="#"><img src="demos/saascandy/assets/images/portfolio/Portfolio.jpg" class="w-100"></a></div>
    ...
    <section class="contact bg-primary position-relative overflow-hidden">
        <div class="container position-relative">
            <div class="dots-shape-left position-absolute"><img src="demos/saascandy/assets/images/icons/dot-shape.png"></div>
            <div class="dots-shape-right position-absolute"><img src="demos/saascandy/assets/images/icons/dot-shape.png"></div>
            <div class="row">
                    ...
                    <div class="owl-carousel owl-theme testimonial">
                        <div class="item">
                            <div class="details position-relative">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="avtar-img rounded-circle overflow-hidden"><img src="demos/saascandy/assets/images/contact/testimonial-image.png" class="img-fluid"></div>
                                    <div class="name ps-3">
                ...
                <div class="row justify-content-center">
                    <div class="col-xx-8 col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                        ...
                        <ul class="d-flex flex-wrap align-items-center list-unstyled mb-0 pl-0 owl-carousel owl-theme trusted-logos">
                            <li class="text-center item"><a href="#"><img src="demos/saascandy/assets/images/contact/google.svg"></a></li>
                            <li class="text-center item"><a href="#"><img src="demos/saascandy/assets/images/contact/microsoft.svg"></a></li>
                            <li class="text-center item"><a href="#"><img src="demos/saascandy/assets/images/contact/amazon.svg"></a></li>
                            <li class="text-center item"><a href="#"><img src="demos/saascandy/assets/images/contact/unique.svg"></a></li>
                            <li class="text-center item"><a href="#"><img src="demos/saascandy/assets/images/contact/google.svg"></a></li>
                            <li class="text-center item"><a href="#"><img src="demos/saascandy/assets/images/contact/microsoft.svg"></a></li>
                            <li class="text-center item"><a href="#"><img src="demos/saascandy/assets/images/contact/amazon.svg"></a></li>
                            <li class="text-center item"><a href="#"><img src="demos/saascandy/assets/images/contact/unique.svg"></a></li>
            ...
            <div class="row">
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="footer-logo-col">
                        <a href="#"><img src="demos/saascandy/assets/images/footer/Logo.svg"></a>
    ...
    <script src="demos/saascandy/dist/js/jquery.min.js"></script>
    <script src="demos/saascandy/dist/js/bootstrap.min.js"></script>
    <script src="demos/saascandy/assets/libs/OwlCarousel-2/dist/owl.carousel.min.js"></script>
    <script src="demos/saascandy/dist/js/custom.js"></script>
