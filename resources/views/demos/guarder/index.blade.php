...
<head>
  ...
  <link rel="shortcut icon" href="demos/guarder/images/favicon.png" type="image/x-icon">

  <title>Guarder</title>

  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="demos/guarder/css/bootstrap.css" />

  <!-- fonts style -->
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,700|Poppins:400,600,700&display=swap" rel="stylesheet" />

  <!-- Custom styles for this template -->
  <link href="demos/guarder/css/style.css" rel="stylesheet" />
  <!-- responsive style -->
  <link href="demos/guarder/css/responsive.css" rel="stylesheet" />
</head>
...
<body>
  <div class="hero_area">
    ...
    <div class="hero_bg_box">
      <div class="img-box">
        <img src="demos/guarder/images/hero-bg.jpg" alt="">
      </div>
    </div>
            ...
            <div class="collapse navbar-collapse ml-auto" id="navbarSupportedContent">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item active">
                  <a class="nav-link" href="{{route('guarder.services')}}"> Services </a>
                </li>
                <li class="nav-item">
      ...
      <div class="row">
        <div class="col-md-6 px-0">
          <div class="img_container">
            <div class="img-box">
              <img src="demos/guarder/images/about-img.jpg" alt="" />
            </div>
          </div>
        </div>
        <div class="col-md-6 px-0">
      ...
      <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="box">
              <div class="img-box">
                <img src="demos/guarder/images/client.png" alt="">
              </div>
              <div class="detail-box">
                <h4>
                  Minim Veniam
  ...
  <section class="contact_section layout_padding">
    <div class="contact_bg_box">
      <div class="img-box">
        <img src="demos/guarder/images/contact-bg.jpg" alt="">
      </div>
    </div>
    <div class="container">
      <div class="heading_container heading_center">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 mx-auto ">
          <div class="box">
            <div class="img-box">
              <img src="demos/guarder/images/t1.jpg" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Martin Anderson
        ...
        <div class="col-md-4 col-sm-6 mx-auto ">
          <div class="box">
            <div class="img-box">
              <img src="demos/guarder/images/t2.jpg" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Denny Butler
        ...
        <div class="col-md-4 col-sm-6 mx-auto ">
          <div class="box">
            <div class="img-box">
              <img src="demos/guarder/images/t3.jpg" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Nathan Mcpherson
  ...
  <script src="demos/guarder/js/jquery-3.4.1.min.js"></script>
  <script src="demos/guarder/js/bootstrap.js"></script>
  <script src="demos/guarder/js/custom.js"></script>
</body>
